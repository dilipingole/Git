...
- (void)layoutSubviews {
    ...
    if (self.sent == YES) {
        ...
        avatarImageFrame = CGRectMake(5.0f+20.0f, timeLabelFrame.size.height, 50.0f, 50.0f);
        ...
        avatarImageFrame = CGRectMake(self.frame.size.width - 55.0f-20.0f, timeLabelFrame.size.height, 50.0f, 50.0f);
    }
